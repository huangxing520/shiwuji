...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Item&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price)&&(identical(other.emoji, emoji) || other.emoji == emoji)&&(identical(other.category, category) || other.category == category)&&(identical(other.location, location) || other.location == location)&&(identical(other.purchaseDate, purchaseDate) || other.purchaseDate == purchaseDate)&&(identical(other.warrantyDays, warrantyDays) || other.warrantyDays == warrantyDays)&&(identical(other.status, status) || other.status == status)&&(identical(other.categoryKey, categoryKey) || other.categoryKey == categoryKey)&&(identical(other.cabinetId, cabinetId) || other.cabinetId == cabinetId)&&(identical(other.slotId, slotId) || other.slotId == slotId)&&const DeepCollectionEquality().equals(other.photos, photos)&&(identical(other.brand, brand) || other.brand == brand)&&(identical(other.note, note) || other.note == note)&&(identical(other.templateKey, templateKey) || other.templateKey == templateKey)&&const DeepCollectionEquality().equals(other.templateData, templateData));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,price,emoji,category,location,purchaseDate,warrantyDays,status,categoryKey,cabinetId,slotId,const DeepCollectionEquality().hash(photos),brand,note,templateKey,const DeepCollectionEquality().hash(templateData));

@override
String toString() {
  return 'Item(id: $id, name: $name, price: $price, emoji: $emoji, category: $category, location: $location, purchaseDate: $purchaseDate, warrantyDays: $warrantyDays, status: $status, categoryKey: $categoryKey, cabinetId: $cabinetId, slotId: $slotId, photos: $photos, brand: $brand, note: $note, templateKey: $templateKey, templateData: $templateData)';
}
...
@useResult
$Res call({
 String id, String name, double price, String emoji, String category, String location, DateTime purchaseDate, int warrantyDays, String status, String categoryKey, String? cabinetId, String? slotId, List<String> photos, String brand, String note, String templateKey, Map<String, String> templateData
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  double price,  String emoji,  String category,  String location,  DateTime purchaseDate,  int warrantyDays,  String status,  String categoryKey,  String? cabinetId,  String? slotId,  List<String> photos,  String brand,  String note,  String templateKey,  Map<String, String> templateData)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Item() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.emoji,_that.category,_that.location,_that.purchaseDate,_that.warrantyDays,_that.status,_that.categoryKey,_that.cabinetId,_that.slotId,_that.photos,_that.brand,_that.note,_that.templateKey,_that.templateData);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  double price,  String emoji,  String category,  String location,  DateTime purchaseDate,  int warrantyDays,  String status,  String categoryKey,  String? cabinetId,  String? slotId,  List<String> photos,  String brand,  String note,  String templateKey,  Map<String, String> templateData)  $default,) {final _that = this;
switch (_that) {
case _Item():
return $default(_that.id,_that.name,_that.price,_that.emoji,_that.category,_that.location,_that.purchaseDate,_that.warrantyDays,_that.status,_that.categoryKey,_that.cabinetId,_that.slotId,_that.photos,_that.brand,_that.note,_that.templateKey,_that.templateData);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  double price,  String emoji,  String category,  String location,  DateTime purchaseDate,  int warrantyDays,  String status,  String categoryKey,  String? cabinetId,  String? slotId,  List<String> photos,  String brand,  String note,  String templateKey,  Map<String, String> templateData)?  $default,) {final _that = this;
switch (_that) {
case _Item() when $default != null:
return $default(_that.id,_that.name,_that.price,_that.emoji,_that.category,_that.location,_that.purchaseDate,_that.warrantyDays,_that.status,_that.categoryKey,_that.cabinetId,_that.slotId,_that.photos,_that.brand,_that.note,_that.templateKey,_that.templateData);case _:
  return null;
...
class _Item extends Item {
  const _Item({required this.id, required this.name, required this.price, this.emoji = '', this.category = '未分类', this.location = '未知', required this.purchaseDate, this.warrantyDays = 365, this.status = 'safe', this.categoryKey = '', this.cabinetId, this.slotId, final  List<String> photos = const [], this.brand = '', this.note = '', this.templateKey = 'none', final  Map<String, String> templateData = const {}}): _photos = photos,_templateData = templateData,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Item&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.price, price) || other.price == price)&&(identical(other.emoji, emoji) || other.emoji == emoji)&&(identical(other.category, category) || other.category == category)&&(identical(other.location, location) || other.location == location)&&(identical(other.purchaseDate, purchaseDate) || other.purchaseDate == purchaseDate)&&(identical(other.warrantyDays, warrantyDays) || other.warrantyDays == warrantyDays)&&(identical(other.status, status) || other.status == status)&&(identical(other.categoryKey, categoryKey) || other.categoryKey == categoryKey)&&(identical(other.cabinetId, cabinetId) || other.cabinetId == cabinetId)&&(identical(other.slotId, slotId) || other.slotId == slotId)&&const DeepCollectionEquality().equals(other._photos, _photos)&&(identical(other.brand, brand) || other.brand == brand)&&(identical(other.note, note) || other.note == note)&&(identical(other.templateKey, templateKey) || other.templateKey == templateKey)&&const DeepCollectionEquality().equals(other._templateData, _templateData));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,price,emoji,category,location,purchaseDate,warrantyDays,status,categoryKey,cabinetId,slotId,const DeepCollectionEquality().hash(_photos),brand,note,templateKey,const DeepCollectionEquality().hash(_templateData));
